...
function loadDevices() {
  ...
  select.innerHTML = `
    <option value="" disabled selected hidden>Select your device model</option>
    <option value="auto">🤖 Auto-detect device (recommended)</option>
  `;
...
// =====================
// SMART DEVICE SEARCH (AUTO PLATFORM + FILTER)
// =====================
